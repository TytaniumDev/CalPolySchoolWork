 ...
 */
public class AddQuestionTrueFalse extends FrameView {

    public AddQuestionTrueFalse(SingleFrameApplication app) {
        super(app);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(edu.calpoly.testtool.TestToolApp.class).getContext().getResourceMap(AddQuestionTrueFalse.class);
