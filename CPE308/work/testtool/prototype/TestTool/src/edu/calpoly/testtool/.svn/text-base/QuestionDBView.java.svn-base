...
public class QuestionDBView extends FrameView {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(edu.calpoly.testtool.TestToolApp.class).getContext().getResourceMap(QuestionDBView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(edu.calpoly.testtool.TestToolApp.class).getContext().getActionMap(QuestionDBView.class, this);
        jMenuItem20.setAction(actionMap.get("quit")); // NOI18N
    ...
    @Action
    public void jMenuItem12Clicked() {
        SingleFrameApplication app = (SingleFrameApplication)this.getApplication();
        app.show(new AddQuestionGenericView(app));
    }
