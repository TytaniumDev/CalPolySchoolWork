...
--            by R. Sunderraman
-- modified by M. Liu,  Spring 2005
-- Warning: The database instance generated is slightly different 
--   from that shown in the Sunderraman book.
---------------------------------------------------------------
...
----------  added by M. Liu -----------
insert into orders values
  (1024,1111,1000,'18-OCT-02','20-OCT-02');
insert into orders values
  (1025,3333,1001,'20-JUN-97',null);
---------------------------------------
